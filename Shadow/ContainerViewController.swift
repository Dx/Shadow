...
class ContainerViewController: UIViewController, CenterViewControllerDelegate, UIGestureRecognizerDelegate {
    ...
    override func viewDidLoad() {
        ...
        centerViewController = UIStoryboard.collectionViewController()
...
private extension UIStoryboard {
    ...
    class func collectionViewController() -> CollectionViewController? {
        return mainStoryboard().instantiateViewControllerWithIdentifier("CollectionViewController") as? CollectionViewController
    }
}